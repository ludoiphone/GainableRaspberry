...
ModifCons::ModifCons()
{
    ...
    connect(m_valid1,&QPushButton::clicked,m_valid1,[this](){selectCons();});
    connect(m_quit1,&QPushButton::clicked,m_quit1,[this](){m_window2 ->close();});
...
{
    m_modifConsignes = new Setting(QString("settings/parametres.ini"), QSettings::IniFormat);
